  ...
  return (
    <div className="profile__preview">
      <div className="profile__preview--container">
        <Link to={'/' + props.profile.username} className="profile__preview--img">
          <img
        ...
        <Link to={'/' + props.profile.username} className="profile__preview--body">
        ...
        <div className="profile__preview--type">
          ...
          <FollowProfile profile={props.profile} currentUser={props.currentUser} />
          </div>
        </div>
      </div>
    </div>
